function CourseReviews({
    ...
    return (
        <div className="p-4">
            ...
            {courseReviews.map((review: { createdAt: string, easy: number, useful: number, liked: number, instructor: string, program: string, body: string }) => (
                <div className="mt-4 flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
