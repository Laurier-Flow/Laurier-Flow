        ...
        <div className="p-4">
          ...
          <div className="pt-4">
            ...
            <TeamMember
              ...
              desc="Muhammad Mujtaba is pursuing a dual degree in Computer Science and Business Administration at the University of Waterloo and Wilfrid Laurier University. Specializing in critical functionalities, Muhammad has adeptly developed the search bar, navigations, and elements of the homepage design, showcasing his ability to enhance user interaction and site efficiency. His expertise also extends into cloud computing, where he excels in deploying scalable and robust cloud solutions. An avid sports enthusiast, Muhammad passionately supports local teams like the Toronto Raptors and the Maple Leafs, reflecting his team-oriented mindset and community spirit."
            />
            <TeamMember
              ...
              desc="Abdullah Shahid is studying for a dual degree in Computer Science and Business Administration at the University of Waterloo and Wilfrid Laurier University. Abdullah has focused his expertise primarily on developing robust authentication flows and other essential components of the project. His technical prowess ensures secure and efficient user experiences. Alongside his academic and professional pursuits, Abdullah is passionate about maintaining his fitness, regularly hitting the gym, and engaging in martial arts such as jiu jitsu and wrestling."
            />
            <TeamMember
              name="Soham Nagi"
