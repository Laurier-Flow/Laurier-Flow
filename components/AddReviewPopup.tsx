...
export default function AddReviewPopup({
    ...
    return (
        <div ref={popupRef} className="overflow-y-auto max-h-[90vh] border-2 border-secondary dark:border-secondary fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-background dark:bg-background/80 backdrop-blur rounded-md max-w-xl w-11/12">
            <form
            ...
            >
                ...
                <div className='p-4 flex flex-col justify-between'>
                    ...
                    <div className='flex flex-1 flex-col pt-8'>
                        ...
                        <textarea onChange={handleTextChange} value={text} id="hs-textarea-with-corner-hint" className="bg-stone-200 py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-amber-300 focus:ring-amber-400 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" rows={3} placeholder="Say something..."></textarea>
                    </div>
                </div>
                <div className='p-4 flex flex-row-reverse'>
                    <button type="submit" className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-base rounded-lg border border-transparent bg-secondary dark:text-white disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        Submit
                    </button>
                </div>
            </form>
