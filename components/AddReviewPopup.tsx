            ...
            >
                ...
                <div className='p-4 flex flex-col justify-between'>
                    ...
                    <div className='flex flex-1 flex-col pt-8'>
                        ...
                        <textarea onChange={handleTextChange} value={text} id="hs-textarea-with-corner-hint" className="bg-stone-200 py-3 px-4 block w-full border-gray-200 rounded-lg text-md focus:border-amber-300 focus:ring-amber-400 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" rows={3} placeholder="Say something..."></textarea>
                    </div>
                </div>
