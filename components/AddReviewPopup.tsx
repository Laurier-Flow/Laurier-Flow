...
export default function AddReviewPopup({
    ...
    return (
        <div ref={popupRef} className="overflow-y-auto max-h-[90vh] border-2 border-slate-600 dark:border-slate-800 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-background dark:bg-background/80 backdrop-blur rounded-md max-w-xl w-11/12">
            <form
            ...
            >
                ...
                <div className='p-4 flex flex-col justify-between'>
                        ...
                        <div className='flex flex-col justify-around sm:flex-row mt-8 p-4 rounded-lg border dark:border-gray-700 dark:bg-slate-900'>
                            <div className='pb-4 self-center sm:self-start sm:pb-0'>
                                ...
                                <div className="flex items-center py-2">
                                    <button onMouseLeave={() => setEasyHover(easy)} onMouseOver={() => setEasyHover(1)} onClick={() => setEasy(1)} type="button" className={`${easy > 0 ? 'text-yellow-400' : 'text-gray-300'} ${(easy > 0) || (easyHover > 0) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                    ...
                                    <button onMouseLeave={() => setEasyHover(easy)} onMouseOver={() => setEasyHover(2)} onClick={() => setEasy(2)} type="button" className={`${easy > 1 ? 'text-yellow-400' : 'text-gray-300'} ${(easy > 1) || (easyHover > 1) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setEasyHover(easy)} onMouseOver={() => setEasyHover(3)} onClick={() => setEasy(3)} type="button" className={`${easy > 2 ? 'text-yellow-400' : 'text-gray-300'} ${(easy > 2) || (easyHover > 2) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setEasyHover(easy)} onMouseOver={() => setEasyHover(4)} onClick={() => setEasy(4)} type="button" className={`${easy > 3 ? 'text-yellow-400' : 'text-gray-300'} ${(easy > 3) || (easyHover > 3) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setEasyHover(easy)} onMouseOver={() => setEasyHover(5)} onClick={() => setEasy(5)} type="button" className={`${(easy > 4) || (easyHover > 4) ? 'text-yellow-400' : 'text-gray-300'} ${(easy > 4) || (easyHover > 4) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5 " xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                            ...
                            <div className='self-center sm:self-start py-4 sm:py-0 sm:px-8 sm:border-x dark:border-gray-700'>
                                ...
                                <div className="flex items-center pt-2 py-2">
                                    <button onMouseLeave={() => setUsefulHover(useful)} onMouseOver={() => setUsefulHover(1)} onClick={() => setUseful(1)} type="button" className={`${useful > 0 ? 'text-yellow-400' : 'text-gray-300'} ${(useful > 0) || (usefulHover > 0) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setUsefulHover(useful)} onMouseOver={() => setUsefulHover(2)} onClick={() => setUseful(2)} type="button" className={`${useful > 1 ? 'text-yellow-400' : 'text-gray-300'} ${(useful > 1) || (usefulHover > 1) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setUsefulHover(useful)} onMouseOver={() => setUsefulHover(3)} onClick={() => setUseful(3)} type="button" className={`${useful > 2 ? 'text-yellow-400' : 'text-gray-300'} ${(useful > 2) || (usefulHover > 2) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setUsefulHover(useful)} onMouseOver={() => setUsefulHover(4)} onClick={() => setUseful(4)} type="button" className={`${useful > 3 ? 'text-yellow-400' : 'text-gray-300'} ${(useful > 3) || (usefulHover > 3) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                                    <button onMouseLeave={() => setUsefulHover(useful)} onMouseOver={() => setUsefulHover(5)} onClick={() => setUseful(5)} type="button" className={`${(useful > 4) || (usefulHover > 4) ? 'text-yellow-400' : 'text-gray-300'} ${(useful > 4) || (usefulHover > 4) ? 'text-yellow-400 dark:text-yellow-600' : 'dark:text-gray-600'} size-5 inline-flex justify-center items-center text-2xl rounded-full text-gray-300 hover:text-yellow-400 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-600 dark:hover:text-yellow-500`}>
                                        <svg className="w-6 h-6 flex-shrink-0 size-5 " xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
                                        </svg>
                                    </button>
                    ...
                    <div className='flex flex-1 flex-col pt-8'>
                        ...
                        <textarea onChange={handleTextChange} value={text} id="hs-textarea-with-corner-hint" className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-amber-300 focus:ring-amber-400 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" rows={3} placeholder="Say something..."></textarea>
                    </div>
                </div>
                <div className='p-4 flex flex-row-reverse'>
                    <button type="submit" className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-amber-300 hover:bg-amber-700 dark:bg-primary dark:text-white dark:hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        Submit
                    </button>
                </div>
            </form>
