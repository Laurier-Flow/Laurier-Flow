      ...
      <div className="pl-8">
        <div className="flex items-center">
          <a href={linkedinUrl} className="">
            <div className="flex items-center">
              <p className="tracking-wide text-lg pr-2 font-semibold">{name}</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-4 text-blue-600 hover:text-blue-800 h-4"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <a
            href={githubUrl}
            className="text-green-400 pl-2 hover:text-green-800"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-4 h-4"
          ...
          <a href={igUrl} className="text-pink-600 pl-2 hover:text-pink-800">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-4 h-4"
              fill="currentColor"
