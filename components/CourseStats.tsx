...
function CourseStats(
    ...
    return (
        <div className='flex flex-col p-4 lg:dark:bg-slate-950 lg:bg-slate-50 lg:rounded-tl-full rounded-bl-full lg:shadow lg:dark:shadow-slate-600'>
                ...
                <div className="relative h-40 w-40">
                    <svg className="h-full w-full" width="36" height="36" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g className="origin-center -rotate-90 transform">
                            <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-amber-400 dark:text-primary" strokeWidth="2" strokeDasharray="100" strokeDashoffset={`${courseData[0].total_reviews !== 0
                ...
                <div className="flex flex-col flex-1 justify-evenly p-4">
                    <div>
                        ...
                        <div className="flex w-full h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-800" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                            <div className="flex flex-col justify-center rounded-full overflow-hidden bg-amber-400 text-xs text-white text-center whitespace-nowrap transition duration-500 dark:bg-primary" style={{ width: `${courseData[0].easy * 20}%` }}></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex w-full h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-800" role="progressbar" aria-valuenow={25} aria-valuemin={0} aria-valuemax={100}>
                            <div className="flex flex-col justify-center rounded-full overflow-hidden bg-amber-400 text-xs text-white text-center whitespace-nowrap transition duration-500 dark:bg-primary" style={{ width: `${courseData[0].useful * 20}%` }}></div>
                        </div>
                    </div>
            ...
            <h3 className='lg:hidden pt-4'>{courseDescription}</h3>
        </div>
    )
}
